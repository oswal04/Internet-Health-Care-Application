...
public class ManagePharmacyOrganizationJPanel extends javax.swing.JPanel {
    ...
    public ManagePharmacyOrganizationJPanel(JPanel userProcessContainer,Enterprise enterprise) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        for (OrganizationType type : Organization.OrganizationType.values()){
            if (type.getValue().equals(OrganizationType.PharmacyPharmacist.getValue())||type.getValue().equals(OrganizationType.PharmacyAdmin.getValue()))
