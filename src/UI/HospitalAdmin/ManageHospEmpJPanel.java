 ...
 * @author Chirag
 */
public class ManageHospEmpJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageHospEmpJPanel
     */
    private OrganizationDirectory organizationDir;
    private JPanel userProcessContainer;

    public ManageHospEmpJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDir) {
        initComponents();
    ...
    private void populateTable(Organization organization) {
        ...
        for (Employee employee : organization.getEmployeeDirectory().getEmployeeList()) {
            ...
            row[1] = employee.getFname()+" "+employee.getLname();
            model.addRow(row);
        }
    }
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if (organization instanceof HospitalDoctorOrganization) {
            organization.getEmployeeDirectory().createDoctor(name, lname);
        } else {
            organization.getEmployeeDirectory().createEmployee(name,lname);
        }
        populateTable(organization);
